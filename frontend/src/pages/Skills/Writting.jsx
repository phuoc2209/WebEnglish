    ...
    useEffect(() => {
        const fetchLessons = async () => {
            ...
            try {
                ...
                const response = await getSkillLessonsByType('writing', pagination.limit, pagination.offset);
            ...
            <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                <div className="max-w-7xl mx-auto px-4 py-16">
                    <div className="text-center">
                        ...
                        <h1 className="text-4xl font-bold mb-4">Writing Skills</h1>
                        <p className="text-xl text-indigo-100 max-w-2xl mx-auto">
                            Thành thạo kỹ năng viết tiếng Anh với các bài học có cấu trúc rõ ràng và bài tập viết sáng tạo.
                        </p>
                    </div>
                </div>
            </div>
