...
import { Mic, Clock, Star, Users, ChevronRight, Pen, Award } from 'lucide-react';
    ...
    const fetchLessons = async () => {
      ...
      try {
        ...
        if (response.status === 'success') {
          ...
          const mappedLessons = speakingLessons.map(lesson => ({
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 bg-teal-600 text-white px-4 py-2 rounded-lg hover:bg-teal-700 transition-colors text-sm font-medium flex items-center justify-center"
                  >
